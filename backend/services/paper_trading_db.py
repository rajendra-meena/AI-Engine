"""
Paper Trading DB — persistence layer for paper-trading positions, trades,
events, execution attempts, and account snapshots.

Includes both the schema initialisation and all CRUD operations.
"""
